                ...
                try:
                    ...
                    if isinstance(query_results, pd.DataFrame):
                        ...
                        if not query_results.empty:
                            ...
                            # Empty result set – rule returned no rows, skip silently
                            pass
...
def analyze_all_warehouses(rules_file_path, labs, workspace_filter=None):
    ...
    warehouses_df = all_items_df[
        ...
        (~all_items_df['name'].str.startswith('DataflowsStaging')) &
        (~all_items_df['name'].str.startswith('StagingWarehouseForDataflows'))
    ].copy()
